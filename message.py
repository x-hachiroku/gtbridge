...
HALFWIDTH_NEG_LOOKBEHIND = r'(?<![0-9A-Za-z\-_<>()\[\]{}\.\'";:])'
...
class MessageList:
    ...
    def append(self, text, name='', original='', pre='', post='', tags=None):
        ...
        _pre, content, _post = MESSAGE_PATTERN.search(self.preprocess(text, tags)).groups()
        pre = pre + _pre
        post = _post + post
        ...
        for bracket in BRACKETS:
            ...
            elif content.count(bracket[0]) > content.count(bracket[1]):
